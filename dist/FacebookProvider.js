...
class Facebook extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "handleInit", /*#__PURE__*/(0, _asyncToGenerator2.default)(function* () {
      // do not run if SSR
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_FacebookContext.default.Provider, {
      value: value
    }, children);
  }

...
class Login extends _react.Component {
  constructor(...args) {
    ...
    super(...args);
    _this = this;
    (0, _defineProperty2.default)(this, "handleClick", /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2.default)(function* (evn) {
        ...
        try {
          yield handleProcess( /*#__PURE__*/function () {
            var _ref2 = (0, _asyncToGenerator2.default)(function* (api) {
              ...
              if (onCompleted) {
                yield onCompleted(_objectSpread(_objectSpread({}, data), {}, {
                  eventKey
                }));
              }
...
var _default = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => /*#__PURE__*/_react.default.createElement(_Process.default, null, ({
  loading,
  handleProcess,
  data,
  error
}) => /*#__PURE__*/_react.default.createElement(Login, (0, _extends2.default)({}, props, {
  loading: loading,
